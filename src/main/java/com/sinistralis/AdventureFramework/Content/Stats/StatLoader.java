...
public class StatLoader {
        ...
        public static void load()
        {
            ...
            AttributeController.loadAttribute(health.getName(), health);
            ...
            AttributeController.loadAttribute(power.getName(), power);
            ...
            AttributeController.loadAttribute(armor.getName(), armor);
        }
